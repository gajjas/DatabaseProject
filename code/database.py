...
class Queries:
    ...
    def populationChange(self, county_name, start_year, end_year):
        ...
        cursor.execute(query, (county_name, start_year, end_year, 0, 0, 0, 0, 0, 0,))
        records = cursor.fetchone()
        return records

    def employmentChange(self, county_name, start_year, end_year):
    ...
    def getPopulationByCounty(self, county_name):
        cursor = self.conn.cursor(cursor_factory=psycopg2.extras.DictCursor)
    ...
    def getEmploymentByCounty(self, county_name):
        cursor = self.conn.cursor(cursor_factory=psycopg2.extras.DictCursor)
        county_name = county_name.strip() + " County"
